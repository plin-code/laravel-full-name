# This is my package laravel-full-name
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-full-name.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-full-name)
...
```bash
php artisan vendor:publish --tag="laravel-full-name-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-full-name-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-full-name-views"
```

## Usage

```php
$laravelFullName = new PlinCode\LaravelFullName();
echo $laravelFullName->echoPhrase('Hello, PlinCode!');
```
