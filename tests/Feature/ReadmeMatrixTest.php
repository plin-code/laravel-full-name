...
dataset('readme_matrix', [
    ...
    'maria substring on first' => ['maria', ['Mariacarmela', 'Rossi'], true],
    'maria rossi not contiguous' => ['maria rossi', ['Mariacarmela', 'Rossi'], false],
    'mariacarmela rossi contiguous' => ['mariacarmela rossi', ['Mariacarmela', 'Rossi'], true],
